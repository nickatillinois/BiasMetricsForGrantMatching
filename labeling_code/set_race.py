...
current = pd.read_csv('model_race.csv')
...
#Unknown:  32360
#Unknown Percentage:  0.12651348995046582
#      asian     black  hispanic     white model_labels  APPLICATION_ID
#0  0.011738  0.302754  0.009565  0.675942            w         3058922
#1  0.065119  0.035089  0.051177  0.848615            w         3058923
#2  0.021448  0.171206  0.008665  0.798681            w         3058926
#3  0.018820  0.019031  0.018729  0.943420            w         3058931
#4  0.013449  0.006330  0.006172  0.974049            w         3058937
#Size before:  255783
#Size after:  223423
#Size difference:  32360
#Size percentage:  0.12651348995046582

df.to_csv('model_race_classification.csv', index=False)