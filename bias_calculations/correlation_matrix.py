...
def create_combined_figure_race():
    ...
    extrinsic_columns=['o_wi_bias_a_mean_desc','o_wi_bias_b_mean_desc','o_wi_bias_h_mean_desc','o_wi_bias_fb_mean_desc'],
     custom_labels={
        ...
        'o_wi_bias_a_mean_desc':'A-W_DescDiff@1',
        'o_wi_bias_b_mean_desc':'B-W_DescDiff@1',
        'o_wi_bias_h_mean_desc':'H-W_DescDiff@1',
        'o_wi_bias_fb_mean_desc': 'BF-WF_DescDiff@1',
    },
    ...
    compute_correlation_matrix_for_subplot(axes[0, 1],
        intrinsic_columns=['disco_asian','disco_black','disco_hispanic','SEAT_ABW','tan_SEAT_ABW','lau_SEAT_ABW',
            'SEAT_EAvsAA', 'tan_SEAT_EAvsAA', 'lau_SEAT_EAvsAA'],
        extrinsic_columns=['o_w_bias_b_mean_desc','o_w_bias_a_mean_desc','o_w_bias_h_mean_desc','o_w_bias_fb_mean_desc'],
        custom_labels={
            'disco_asian': 'DisCo (A-W)',
            'disco_black': 'DisCo (B-W)',
            'disco_hispanic': 'DisCo (H-W)',
            ...
            'tan_SEAT_EAvsAA': 'Tan et al. (2019) (W-B)',
            'lau_SEAT_EAvsAA': 'Lauscher et al. (2021) (W-B)',
            'o_w_bias_a_mean_desc':'A-W_DescDiff@1',
            'o_w_bias_b_mean_desc':'B-W_DescDiff@1',
            'o_w_bias_h_mean_desc':'H-W_DescDiff@1',
            'o_w_bias_fb_mean_desc': 'BF-WF_DescDiff@1',
        },
    ...
    compute_correlation_matrix_for_subplot(axes[1, 0],
        intrinsic_columns=['disco_asian','disco_black','disco_hispanic','SEAT_ABW','tan_SEAT_ABW','lau_SEAT_ABW',
            'SEAT_EAvsAA', 'tan_SEAT_EAvsAA', 'lau_SEAT_EAvsAA'],
        extrinsic_columns=['r_wi_bias_b_mean_desc','r_wi_bias_a_mean_desc','r_wi_bias_h_mean_desc','r_wi_bias_fb_mean_desc'],
        custom_labels={
            'disco_asian': 'DisCo (A-W)',
            'disco_black': 'DisCo (B-W)',
            'disco_hispanic': 'DisCo (H-W)',
            ...
            'tan_SEAT_EAvsAA': 'Tan et al. (2019) (W-B)',
            'lau_SEAT_EAvsAA': 'Lauscher et al. (2021) (W-B)',
            'r_wi_bias_a_mean_desc':'A-W_DescDiff@1',
            'r_wi_bias_b_mean_desc':'B-W_DescDiff@1',
            'r_wi_bias_h_mean_desc':'H-W_DescDiff@1',
            'r_wi_bias_fb_mean_desc': 'BF-WF_DescDiff@1',
        },
    ...
    compute_correlation_matrix_for_subplot(axes[1, 1],
        intrinsic_columns=['disco_asian','disco_black','disco_hispanic','SEAT_ABW','tan_SEAT_ABW','lau_SEAT_ABW',
            'SEAT_EAvsAA', 'tan_SEAT_EAvsAA', 'lau_SEAT_EAvsAA'],
        extrinsic_columns=['r_w_bias_b_mean_desc','r_w_bias_a_mean_desc','r_w_bias_h_mean_desc','r_w_bias_fb_mean_desc'],
        custom_labels={
            'disco_asian': 'DisCo (A-W)',
            'disco_black': 'DisCo (B-W)',
            'disco_hispanic': 'DisCo (H-W)',
            ...
            'tan_SEAT_EAvsAA': 'Tan et al. (2019) (W-B)',
            'lau_SEAT_EAvsAA': 'Lauscher et al. (2021) (W-B)',
            'r_w_bias_a_mean_desc':'A-W_DescDiff@1',
            'r_w_bias_b_mean_desc':'B-W_DescDiff@1',
            'r_w_bias_h_mean_desc':'H-W_DescDiff@1',
            'r_w_bias_fb_mean_desc': 'BF-WF_DescDiff@1',
        },
    ...
    compute_correlation_matrix_for_subplot(axes[2, 0],
        intrinsic_columns=['disco_asian','disco_black','disco_hispanic','SEAT_ABW','tan_SEAT_ABW','lau_SEAT_ABW',
            'SEAT_EAvsAA', 'tan_SEAT_EAvsAA', 'lau_SEAT_EAvsAA'],
        extrinsic_columns=['p_wi_bias_b_mean_desc','p_wi_bias_a_mean_desc','p_wi_bias_h_mean_desc','p_wi_bias_fb_mean_desc'],
        custom_labels={
            'disco_asian': 'DisCo (A-W)',
            'disco_black': 'DisCo (B-W)',
            'disco_hispanic': 'DisCo (H-W)',
            ...
            'tan_SEAT_EAvsAA': 'Tan et al. (2019) (W-B)',
            'lau_SEAT_EAvsAA': 'Lauscher et al. (2021) (W-B)',
            'p_wi_bias_a_mean_desc':'A-W_DescDiff@1',
            'p_wi_bias_b_mean_desc':'B-W_DescDiff@1',
            'p_wi_bias_h_mean_desc':'H-W_DescDiff@1',
            'p_wi_bias_fb_mean_desc': 'BF-WF_DescDiff@1',
        },
    ...
    compute_correlation_matrix_for_subplot(axes[2, 1],
        intrinsic_columns=['disco_asian','disco_black','disco_hispanic','SEAT_ABW','tan_SEAT_ABW','lau_SEAT_ABW',
            'SEAT_EAvsAA', 'tan_SEAT_EAvsAA', 'lau_SEAT_EAvsAA'],
        extrinsic_columns=['p_w_bias_b_mean_desc','p_w_bias_a_mean_desc','p_w_bias_h_mean_desc','p_w_bias_fb_mean_desc'],
        custom_labels={
            'disco_asian': 'DisCo (A-W)',
            'disco_black': 'DisCo (B-W)',
            'disco_hispanic': 'DisCo (H-W)',
            ...
            'tan_SEAT_EAvsAA': 'Tan et al. (2019) (W-B)',
            'lau_SEAT_EAvsAA': 'Lauscher et al. (2021) (W-B)',
            'p_w_bias_a_mean_desc':'A-W_DescDiff@1',
            'p_w_bias_b_mean_desc':'B-W_DescDiff@1',
            'p_w_bias_h_mean_desc':'H-W_DescDiff@1',
            'p_w_bias_fb_mean_desc': 'BF-WF_DescDiff@1',
        },
    ...
    plt.tight_layout()
    plt.savefig("race_correlation_matrices.eps")
    plt.show()
...
def create_combined_figure_gender():
    ...
    compute_correlation_matrix_for_subplot(axes[0, 0], 
        ...
        extrinsic_columns=['o_wi_bias_f_mean_desc'],
        custom_labels={
            ...
            'o_wi_bias_f_mean_desc': 'F-M_DescDiff@1',
        },
        custom_title='Original Data without PI Names'
    )
    compute_correlation_matrix_for_subplot(axes[1, 0], 
        intrinsic_columns=['disco_gender','lpbs_mean','SEAT_gender','tan_SEAT_gender', 'lau_SEAT_gender'],
        extrinsic_columns=['o_w_bias_f_mean_desc'],
        custom_labels={
            'disco_gender': 'DisCo (Gender)',
            'lpbs_mean': 'LPBS',
            'SEAT_gender': 'May et al. (2019)',
            'tan_SEAT_gender': 'Tan et al. (2019)',
            'lau_SEAT_gender': 'Lauscher et al. (2021)',
            'o_w_bias_f_mean_desc': 'F-M_DescDiff@1',
        },
        custom_title='Original Data with PI Names'
    )
    compute_correlation_matrix_for_subplot(axes[0, 1], 
        intrinsic_columns=['disco_gender','lpbs_mean','SEAT_gender','tan_SEAT_gender', 'lau_SEAT_gender'],
        extrinsic_columns=['r_wi_bias_f_mean_desc'],
        custom_labels={
            'disco_gender': 'DisCo (Gender)',
            'lpbs_mean': 'LPBS',
            'SEAT_gender': 'May et al. (2019)',
            'tan_SEAT_gender': 'Tan et al. (2019)',
            'lau_SEAT_gender': 'Lauscher et al. (2021)',
            'r_wi_bias_f_mean_desc': 'F-M_DescDiff@1',
        },
        custom_title='Realistic Data without PI Names'
    )
    compute_correlation_matrix_for_subplot(axes[1, 1],
        intrinsic_columns=['disco_gender','lpbs_mean','SEAT_gender','tan_SEAT_gender', 'lau_SEAT_gender'],
        extrinsic_columns=['r_w_bias_f_mean_desc'],
        custom_labels={
            'disco_gender': 'DisCo (Gender)',
            'lpbs_mean': 'LPBS',
            'SEAT_gender': 'May et al. (2019)',
            'tan_SEAT_gender': 'Tan et al. (2019)',
            'lau_SEAT_gender': 'Lauscher et al. (2021)',
            'r_w_bias_f_mean_desc': 'F-M_DescDiff@1',
        },
        custom_title='Realistic Data with PI Names'
    )
    compute_correlation_matrix_for_subplot(axes[0, 2],
        intrinsic_columns=['disco_gender','lpbs_mean','SEAT_gender','tan_SEAT_gender', 'lau_SEAT_gender'],
        extrinsic_columns=['p_wi_bias_f_mean_desc'],
        custom_labels={
            'disco_gender': 'DisCo (Gender)',
            'lpbs_mean': 'LPBS',
            'SEAT_gender': 'May et al. (2019)',
            'tan_SEAT_gender': 'Tan et al. (2019)',
            'lau_SEAT_gender': 'Lauscher et al. (2021)',
            'p_wi_bias_f_mean_desc': 'F-M_DescDiff@1',
        },
        custom_title='Balanced Data without PI Names'
    )
    compute_correlation_matrix_for_subplot(axes[1, 2],
        intrinsic_columns=['disco_gender','lpbs_mean','SEAT_gender','tan_SEAT_gender', 'lau_SEAT_gender'],
        extrinsic_columns=['p_w_bias_f_mean_desc'],
        custom_labels={
            'disco_gender': 'DisCo (Gender)',
            'lpbs_mean': 'LPBS',
            'SEAT_gender': 'May et al. (2019)',
            'tan_SEAT_gender': 'Tan et al. (2019)',
            'lau_SEAT_gender': 'Lauscher et al. (2021)',
            'p_w_bias_f_mean_desc': 'F-M_DescDiff@1',
        },
        custom_title='Balanced Data with PI Names'
    )
    ...
    # Adjust layout to prevent overlap
    plt.tight_layout()
    plt.savefig("gender_correlation_matrices.eps")
...
compute_correlation_matrix_for_subplot(
    intrinsic_columns=['disco_gender','lpbs_mean','SEAT_gender','tan_SEAT_gender', 'lau_SEAT_gender'],
    extrinsic_columns=['o_wi_bias_f_mean_desc','o_wi_bias_f_median_desc','o_wi_bias_f_mean_norm','o_wi_bias_f_median_norm']
)
compute_correlation_matrix_for_subplot(
    intrinsic_columns=['disco_gender','lpbs_mean','SEAT_gender','tan_SEAT_gender', 'lau_SEAT_gender'],
    extrinsic_columns=['o_w_bias_f_mean_desc','o_w_bias_f_median_desc','o_w_bias_f_mean_norm','o_w_bias_f_median_norm']
)
compute_correlation_matrix_for_subplot(
    intrinsic_columns=['disco_gender','lpbs_mean','SEAT_gender','tan_SEAT_gender', 'lau_SEAT_gender'],
    extrinsic_columns=['r_wi_bias_f_mean_desc','r_wi_bias_f_median_desc','r_wi_bias_f_mean_norm','r_wi_bias_f_median_norm']
)
compute_correlation_matrix_for_subplot(
    intrinsic_columns=['disco_gender','lpbs_mean','SEAT_gender','tan_SEAT_gender', 'lau_SEAT_gender'],
    extrinsic_columns=['r_w_bias_f_mean_desc','r_w_bias_f_median_desc','r_w_bias_f_mean_norm','r_w_bias_f_median_norm']
)
compute_correlation_matrix_for_subplot(
    intrinsic_columns=['disco_gender','lpbs_mean','SEAT_gender','tan_SEAT_gender', 'lau_SEAT_gender'],
    extrinsic_columns=['p_wi_bias_f_mean_desc','p_wi_bias_f_median_desc','p_wi_bias_f_mean_norm','p_wi_bias_f_median_norm']
)
compute_correlation_matrix_for_subplot(
    intrinsic_columns=['disco_gender','lpbs_mean','SEAT_gender','tan_SEAT_gender', 'lau_SEAT_gender'],
    extrinsic_columns=['p_w_bias_f_mean_desc','p_w_bias_f_median_desc','p_w_bias_f_mean_norm','p_w_bias_f_median_norm']
)
...
compute_correlation_matrix_for_subplot(
    ...
    extrinsic_columns=['o_wi_bias_b_mean_desc','o_wi_bias_a_mean_desc','o_wi_bias_h_mean_desc','o_wi_bias_fb_mean_desc',    'o_wi_bias_b_median_desc','o_wi_bias_a_median_desc','o_wi_bias_h_median_desc','o_wi_bias_fb_median_desc',    'o_wi_bias_b_mean_norm','o_wi_bias_a_mean_norm','o_wi_bias_h_mean_norm','o_wi_bias_fb_mean_norm',    'o_wi_bias_b_median_norm','o_wi_bias_a_median_norm','o_wi_bias_h_median_norm','o_wi_bias_fb_median_norm']
)
compute_correlation_matrix_for_subplot(
    intrinsic_columns=['SEAT_EAvsAA', 'tan_SEAT_EAvsAA', 'lau_SEAT_EAvsAA','disco_black','disco_asian','disco_hispanic','tan_SEAT_ABW','lau_SEAT_ABW' ,'SEAT_ABW'],
    extrinsic_columns=['r_wi_bias_b_mean_desc','r_wi_bias_a_mean_desc','r_wi_bias_h_mean_desc','r_wi_bias_fb_mean_desc',    'r_wi_bias_b_median_desc','r_wi_bias_a_median_desc','r_wi_bias_h_median_desc','r_wi_bias_fb_median_desc',    'r_wi_bias_b_mean_norm','r_wi_bias_a_mean_norm','r_wi_bias_h_mean_norm','r_wi_bias_fb_mean_norm',    'r_wi_bias_b_median_norm','r_wi_bias_a_median_norm','r_wi_bias_h_median_norm','r_wi_bias_fb_median_norm']
)
compute_correlation_matrix_for_subplot(
    intrinsic_columns=['SEAT_EAvsAA', 'tan_SEAT_EAvsAA', 'lau_SEAT_EAvsAA','disco_black','disco_asian','disco_hispanic','tan_SEAT_ABW','lau_SEAT_ABW' ,'SEAT_ABW'],
    extrinsic_columns=['p_wi_bias_b_mean_desc','p_wi_bias_a_mean_desc','p_wi_bias_h_mean_desc','p_wi_bias_fb_mean_desc',    'p_wi_bias_b_median_desc','p_wi_bias_a_median_desc','p_wi_bias_h_median_desc','p_wi_bias_fb_median_desc',    'p_wi_bias_b_mean_norm','p_wi_bias_a_mean_norm','p_wi_bias_h_mean_norm','p_wi_bias_fb_mean_norm',    'p_wi_bias_b_median_norm','p_wi_bias_a_median_norm','p_wi_bias_h_median_norm','p_wi_bias_fb_median_norm']
)
compute_correlation_matrix_for_subplot(
    intrinsic_columns=['SEAT_EAvsAA', 'tan_SEAT_EAvsAA', 'lau_SEAT_EAvsAA','disco_black','disco_asian','disco_hispanic','tan_SEAT_ABW','lau_SEAT_ABW' ,'SEAT_ABW'],
    extrinsic_columns=['o_w_bias_b_mean_desc','o_w_bias_a_mean_desc','o_w_bias_h_mean_desc','o_w_bias_fb_mean_desc',    'o_w_bias_b_median_desc','o_w_bias_a_median_desc','o_w_bias_h_median_desc','o_w_bias_fb_median_desc',    'o_w_bias_b_mean_norm','o_w_bias_a_mean_norm','o_w_bias_h_mean_norm','o_w_bias_fb_mean_norm',    'o_w_bias_b_median_norm','o_w_bias_a_median_norm','o_w_bias_h_median_norm','o_w_bias_fb_median_norm']
)
compute_correlation_matrix_for_subplot(
    intrinsic_columns=['SEAT_EAvsAA', 'tan_SEAT_EAvsAA', 'lau_SEAT_EAvsAA','disco_black','disco_asian','disco_hispanic','tan_SEAT_ABW','lau_SEAT_ABW' ,'SEAT_ABW'],
    extrinsic_columns=['r_w_bias_b_mean_desc','r_w_bias_a_mean_desc','r_w_bias_h_mean_desc','r_w_bias_fb_mean_desc',    'r_w_bias_b_median_desc','r_w_bias_a_median_desc','r_w_bias_h_median_desc','r_w_bias_fb_median_desc',    'r_w_bias_b_mean_norm','r_w_bias_a_mean_norm','r_w_bias_h_mean_norm','r_w_bias_fb_mean_norm',    'r_w_bias_b_median_norm','r_w_bias_a_median_norm','r_w_bias_h_median_norm','r_w_bias_fb_median_norm']
)
compute_correlation_matrix_for_subplot(
    intrinsic_columns=['SEAT_EAvsAA', 'tan_SEAT_EAvsAA', 'lau_SEAT_EAvsAA','disco_black','disco_asian','disco_hispanic','tan_SEAT_ABW','lau_SEAT_ABW' ,'SEAT_ABW'],
    extrinsic_columns=['p_w_bias_b_mean_desc','p_w_bias_a_mean_desc','p_w_bias_h_mean_desc','p_w_bias_fb_mean_desc',    'p_w_bias_b_median_desc','p_w_bias_a_median_desc','p_w_bias_h_median_desc','p_w_bias_fb_median_desc',    'p_w_bias_b_mean_norm','p_w_bias_a_mean_norm','p_w_bias_h_mean_norm','p_w_bias_fb_mean_norm',    'p_w_bias_b_median_norm','p_w_bias_a_median_norm','p_w_bias_h_median_norm','o_wi_bias_fb_median_norm']
)"""
