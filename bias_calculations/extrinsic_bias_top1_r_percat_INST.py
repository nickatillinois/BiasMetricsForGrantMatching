...
inst_dict_f_a_r_wi = get_precision_inst_top1_for_all_models('r', 'wi', 'f', 'a')
inst_dict_m_a_r_wi = get_precision_inst_top1_for_all_models('r', 'wi', 'm', 'a')
inst_dict_f_b_r_wi = get_precision_inst_top1_for_all_models('r', 'wi', 'f', 'b')
inst_dict_m_b_r_wi = get_precision_inst_top1_for_all_models('r', 'wi', 'm', 'b')
inst_dict_f_h_r_wi = get_precision_inst_top1_for_all_models('r', 'wi', 'f', 'h')
inst_dict_m_h_r_wi = get_precision_inst_top1_for_all_models('r', 'wi', 'm', 'h')
inst_dict_f_w_r_wi = get_precision_inst_top1_for_all_models('r', 'wi', 'f', 'w')
inst_dict_m_w_r_wi = get_precision_inst_top1_for_all_models('r', 'wi', 'm', 'w')

inst_dict_f_a_r_w = get_precision_inst_top1_for_all_models('r', 'w', 'f', 'a')
inst_dict_m_a_r_w = get_precision_inst_top1_for_all_models('r', 'w', 'm', 'a')
inst_dict_f_b_r_w = get_precision_inst_top1_for_all_models('r', 'w', 'f', 'b')
inst_dict_m_b_r_w = get_precision_inst_top1_for_all_models('r', 'w', 'm', 'b')
inst_dict_f_h_r_w = get_precision_inst_top1_for_all_models('r', 'w', 'f', 'h')
inst_dict_m_h_r_w = get_precision_inst_top1_for_all_models('r', 'w', 'm', 'h')
inst_dict_f_w_r_w = get_precision_inst_top1_for_all_models('r', 'w', 'f', 'w')
inst_dict_m_w_r_w = get_precision_inst_top1_for_all_models('r', 'w', 'm', 'w')

inst_changes_f_a_r_w = calculate_changes(inst_dict_f_a_r_wi,inst_dict_f_a_r_w)
inst_changes_m_a_r_w = calculate_changes(inst_dict_m_a_r_wi,inst_dict_m_a_r_w)
inst_changes_f_b_r_w = calculate_changes(inst_dict_f_b_r_wi,inst_dict_f_b_r_w)
inst_changes_m_b_r_w = calculate_changes(inst_dict_m_b_r_wi,inst_dict_m_b_r_w)
inst_changes_f_h_r_w = calculate_changes(inst_dict_f_h_r_wi,inst_dict_f_h_r_w)
inst_changes_m_h_r_w = calculate_changes(inst_dict_m_h_r_wi,inst_dict_m_h_r_w)
inst_changes_f_w_r_w = calculate_changes(inst_dict_f_w_r_wi,inst_dict_f_w_r_w)
inst_changes_m_w_r_w = calculate_changes(inst_dict_m_w_r_wi,inst_dict_m_w_r_w)
precision_dicts = [
    inst_dict_f_a_r_wi,
    inst_dict_m_a_r_wi,
    inst_dict_f_b_r_wi,
...
changes_dicts = [
    inst_dict_f_a_r_wi,
    inst_changes_f_a_r_w,
    inst_dict_m_a_r_wi,
    inst_changes_m_a_r_w,
    inst_dict_f_b_r_wi,
    inst_changes_f_b_r_w,
    inst_dict_m_b_r_wi,
    inst_changes_m_b_r_w,
    inst_dict_f_h_r_wi,
    inst_changes_f_h_r_w,
    inst_dict_m_h_r_wi,
    inst_changes_m_h_r_w,
    inst_dict_f_w_r_wi,
    inst_changes_f_w_r_w,
    inst_dict_m_w_r_wi,
    inst_changes_m_w_r_w
]
...
print(latex_code)
#list_models = [inst_dict_f_a_r_wi[model] for model in model_order]

# Format the values to 2 decimal places as strings
formatted_dict = {k: f"{v:.2f}" for k, v in inst_changes_m_w_r_w .items()}

# Print the formatted dictionary
#print(formatted_dict)
# Prepare data for plotting
wi_data = {
    'f_a_r_wi': [inst_dict_f_a_r_wi[model] for model in model_order],
    'm_a_r_wi': [inst_dict_m_a_r_wi[model] for model in model_order],
    'f_b_r_wi': [inst_dict_f_b_r_wi[model] for model in model_order],
    'm_b_r_wi': [inst_dict_m_b_r_wi[model] for model in model_order],
    'f_h_r_wi': [inst_dict_f_h_r_wi[model] for model in model_order],
    'm_h_r_wi': [inst_dict_m_h_r_wi[model] for model in model_order],
    'f_w_r_wi': [inst_dict_f_w_r_wi[model] for model in model_order],
    'm_w_r_wi': [inst_dict_m_w_r_wi[model] for model in model_order],
}

change_data = {
    'f_a_r_w': [inst_changes_f_a_r_w[model] for model in model_order],
    'm_a_r_w': [inst_changes_m_a_r_w[model] for model in model_order],
    'f_b_r_w': [inst_changes_f_b_r_w[model] for model in model_order],
    'm_b_r_w': [inst_changes_m_b_r_w[model] for model in model_order],
    'f_h_r_w': [inst_changes_f_h_r_w[model] for model in model_order],
    'm_h_r_w': [inst_changes_m_h_r_w[model] for model in model_order],
    'f_w_r_w': [inst_changes_f_w_r_w[model] for model in model_order],
    'm_w_r_w': [inst_changes_m_w_r_w[model] for model in model_order],
}
# Define label names
label_names = {
    'f_a_r_wi': 'Female Asian',
    'm_a_r_wi': 'Male Asian',
    'f_b_r_wi': 'Female Black',
    'm_b_r_wi': 'Male Black',
    'f_h_r_wi': 'Female Hispanic',
    'm_h_r_wi': 'Male Hispanic',
    'f_w_r_wi': 'Female Wite',
    'm_w_r_wi': 'Male White',
    'f_a_r_w': 'Female Asian',
    'm_a_r_w': 'Male Asian',
    'f_b_r_w': 'Female Black',
    'm_b_r_w': 'Male Black',
    'f_h_r_w': 'Female Hispanic',
    'm_h_r_w': 'Male Hispanic',
    'f_w_r_w': 'Female Wite',
    'm_w_r_w': 'Male White',
}
...
width = 0.1
labels = ['f_a_r_wi', 'm_a_r_wi', 'f_b_r_wi', 'm_b_r_wi', 'f_h_r_wi', 'm_h_r_wi', 'f_w_r_wi', 'm_w_r_wi']
...
# Plot change_data
labels_w = ['f_a_r_w', 'm_a_r_w', 'f_b_r_w', 'm_b_r_w', 'f_h_r_w', 'm_h_r_w', 'f_w_r_w', 'm_w_r_w']
...
# Adjust layout
fig.tight_layout()
plt.savefig("inst_r_with_without_percat.eps")
plt.show()