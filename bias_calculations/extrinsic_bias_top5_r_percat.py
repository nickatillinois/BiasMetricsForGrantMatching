...
def calculate_changes(dict_wi, dict_w):
    ...
    return changes
mpe_dict_f_a_o_wi,_ = get_mape_for_all_models('r', 'wi', 'f', 'a')
mpe_dict_m_a_o_wi,_ = get_mape_for_all_models('r', 'wi', 'm', 'a')
mpe_dict_f_b_o_wi,_ = get_mape_for_all_models('r', 'wi', 'f', 'b')
mpe_dict_m_b_o_wi,_ = get_mape_for_all_models('r', 'wi', 'm', 'b')
mpe_dict_f_h_o_wi,_ = get_mape_for_all_models('r', 'wi', 'f', 'h')
mpe_dict_m_h_o_wi,_ = get_mape_for_all_models('r', 'wi', 'm', 'h')
mpe_dict_f_w_o_wi,_ = get_mape_for_all_models('r', 'wi', 'f', 'w')
mpe_dict_m_w_o_wi,_ = get_mape_for_all_models('r', 'wi', 'm', 'w')

mpe_dict_f_a_o_w,_ = get_mape_for_all_models('r', 'w', 'f', 'a')
mpe_dict_m_a_o_w,_ = get_mape_for_all_models('r', 'w', 'm', 'a')
mpe_dict_f_b_o_w,_ = get_mape_for_all_models('r', 'w', 'f', 'b')
mpe_dict_m_b_o_w,_ = get_mape_for_all_models('r', 'w', 'm', 'b')
mpe_dict_f_h_o_w,_ = get_mape_for_all_models('r', 'w', 'f', 'h')
mpe_dict_m_h_o_w,_ = get_mape_for_all_models('r', 'w', 'm', 'h')
mpe_dict_f_w_o_w,_ = get_mape_for_all_models('r', 'w', 'f', 'w')
mpe_dict_m_w_o_w,_ = get_mape_for_all_models('r', 'w', 'm', 'w')
...
# Adjust layout
fig.tight_layout()
plt.savefig("MPE_r_with_without_percat_top5.eps")
plt.show()