...
def calculate_changes(dict_wi, dict_w):
    ...
    return changes
foa_top1_precition_dict_a_a_o_wi = get_precision_foa_top1_for_all_models('p', 'wi', 'all', 'all')
foa_top1_precition_dict_a_a_o_w = get_precision_foa_top1_for_all_models('p', 'w', 'all', 'all')
inst_top1_precition_dict_a_a_o_wi = get_precision_inst_top1_for_all_models('p', 'wi', 'all', 'all')
inst_top1_precition_dict_a_a_o_w = get_precision_inst_top1_for_all_models('p', 'w', 'all', 'all')
mpe_dict_a_a_o_wi, _ = get_mape_for_all_models('p', 'wi', 'all', 'all')
mpe_dict_a_a_o_w, _ = get_mape_for_all_models('p', 'w', 'all', 'all')
...
plt.savefig("performance_balanced_top5.eps", bbox_inches='tight')
plt.show()
