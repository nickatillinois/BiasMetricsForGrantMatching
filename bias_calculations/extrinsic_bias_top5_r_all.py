...
def calculate_changes(dict_wi, dict_w):
    ...
    return changes
foa_top1_precition_dict_a_a_o_wi = get_precision_foa_top1_for_all_models('r', 'wi', 'all', 'all')
foa_top1_precition_dict_a_a_o_w = get_precision_foa_top1_for_all_models('r', 'w', 'all', 'all')
inst_top1_precition_dict_a_a_o_wi = get_precision_inst_top1_for_all_models('r', 'wi', 'all', 'all')
inst_top1_precition_dict_a_a_o_w = get_precision_inst_top1_for_all_models('r', 'w', 'all', 'all')
mpe_dict_a_a_o_wi, _ = get_mape_for_all_models('r', 'wi', 'all', 'all')
mpe_dict_a_a_o_w, _ = get_mape_for_all_models('r', 'w', 'all', 'all')
...
# Prepare data
metrics = ['Type@5', 'Inst@5', 'MPE']
wi_data = {
    'Type@5': [foa_top1_precition_dict_a_a_o_wi[model] for model in model_order],
    'Inst@5': [inst_top1_precition_dict_a_a_o_wi[model] for model in model_order],
    'MPE': [mpe_dict_a_a_o_wi[model] for model in model_order]
}
change_data = {
    'Type@5': [foa_top1_precition_changes[model] for model in model_order],
    'Inst@5': [inst_top1_precition_changes[model] for model in model_order],
...
plt.savefig("performance_realistic_top5.eps", bbox_inches='tight')
plt.show()
