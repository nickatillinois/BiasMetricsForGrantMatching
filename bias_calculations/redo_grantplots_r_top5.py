...
avg_grant_values_wi = average_grant_top1_val('r', 'wi','all', 'all')
print(avg_grant_values_wi)
avg_grant_values_w = average_grant_top1_val('r', 'w','all', 'all')
...
plt.savefig('comparison_grant_value_plots_r_top5.eps', bbox_inches='tight')
plt.show()
