...
# Define the order for race and gender'o'
...
plt.tight_layout()
plt.savefig('combined_grant_value_plots_o_top5.png')
plt.show()
plt.close()
...
plt.savefig('comparison_grant_value_plots_o_top5.eps', bbox_inches='tight')
plt.show()
