...
def load_dataset():
    df_professions = pd.read_csv("professionsBLS2015.csv")
...
# Flatten the male_list and female_list
flat_male_list = [item for sublist in dataset.male_list for item in sublist]
flat_female_list = [item for sublist in dataset.female_list for item in sublist]

# Print the flattened male_list and female_list
print("Male List:")
print(", ".join(flat_male_list))

print("\nFemale List:")
print(", ".join(flat_female_list))